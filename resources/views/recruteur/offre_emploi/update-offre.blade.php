    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8 col-sm-12 col-12 mb-50">
                ...
                <div class="col-lg-9 col-md-8 col-sm-12 col-12 mb-50">
                    <form method="POST" action="{{ route('recruteur.offre.update',['offre'=>$offre]) }}">
                        @csrf
                        @method('put')
                            ...
                            <div class="row form-contact">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="poste" class="form-control @error('poste') is-invalid @enderror" type="text" value="{{$offre->poste}}">
                                        @error('poste')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="date_fin_offre" class="form-control @error('date_fin_offre') is-invalid @enderror" type="date" value="{{ $offre->date_fin_offre }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="salaire" class="form-control @error('salaire') is-invalid @enderror" type="text" value="{{ $offre->salaire }}">
                                        @error('salaire')
                                            <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="lieu" class="form-control @error('lieu') is-invalid @enderror" type="text" value="{{ $offre->lieu }}">
                                        @error('lieu')
                                            <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="4">{{ $offre->description }}</textarea>
                                        @error('description')
                                            <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="exigence" class="form-control @error('exigence') is-invalid @enderror" rows="4">{{ $offre->exigence }}</textarea>
                                        @error('exigence')
                                            <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                        @enderror
                                    </div>
